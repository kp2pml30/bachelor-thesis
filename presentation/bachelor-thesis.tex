...
\begin{column}{0.5\textwidth}
\begin{center}
	\Resizebox[\scaleForComps]{!}{0.8\textheight}{
...
\begin{frame}
\frametitle{Sunspider/AccessNBody --- Результаты интерпретации}
\begin{center}
...
\begin{center}
\includesvg[height=0.80\textheight]{build/res/data-build/access-nbody-wide}
\end{center}
\end{frame}
